...
import 'package:leadvala/screens/app_pages_screens/slot_booking_screen/layouts/time_slot_layout.dart';
...
class ProviderTimeSlotLayout extends StatelessWidget {
  ...
  const ProviderTimeSlotLayout({super.key, this.isService, this.selectProviderIndex, this.service});

  @override
  Widget build(BuildContext context) {
    return Consumer<SlotBookingProvider>(builder: (context1, value, child) {
      return StatefulWrapper(
        onInit: () => Future.delayed(DurationClass.ms50).then((_) => value.onInit(context,
            isPackage: isService, index: selectProviderIndex, service: service, isProviderTimeSlot: true)),
        child: SizedBox(
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          Container(
                                  ...
                                  child: DropdownButton(
                                      ...
                                      onChanged: (choseVal) => value.onDropDownChange(choseVal, context)))
                                ...
                                defaultBuilder: (context, day, focusedDay) => Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      width: Sizes.s30,
                                      decoration:
                                          BoxDecoration(color: appColor(context).whiteColor, shape: BoxShape.circle),
                                      child: Text(
                                        day.day.toString(),
                                    ...
                                    Container(
                                        ...
                                        width: Sizes.s5,
                                        decoration:
                                            BoxDecoration(color: appColor(context).trans, shape: BoxShape.circle)),
                                  ],
                                ),
                        ...
                        Row(
                            children: appArray.amPmList
                                ...
                                .map((e) => AmPmLayout(
                                    ...
                                    onTap: () => value.onAmPmChange(context, e.key)))
                                .toList())
                      ]),
                                  ...
                                  return Container(
                                    ...
                                    child: Text(value.timeSlot[index],
                                        style: value.timeIndex == index
                                            ? appCss.dmDenseRegular14.textColor(appColor(context).whiteColor)
                                            : appCss.dmDenseMedium14.textColor(appColor(context).lightText)),
                                  ).inkWell(onTap: () => value.onChangeSlot(index));
                                })
                            : Column(children: [
                                Image.asset(eImageAssets.notFound, height: Sizes.s80, width: Sizes.s150),
