                ...
                Expanded(
                  ...
                  value.selectIndex == 0
                      ? Expanded(
                          ...
                          child: Column(children: [
                            ...dash.bookingStatusList.asMap().entries.map((e) => BookingStatusFilterLayout(
                                title: e.value.name.toString().capitalizeFirst(),
                                index: e.key,
                              ...
                              child: SingleChildScrollView(
                                child: Column(children: [
                                  SearchTextFieldCommon(
                                    ...
                                    suffixIcon: value.categoryCtrl.text.isNotEmpty
                                        ? Icon(
                                            Icons.cancel,
                                            ...
                                            if (value.selectIndex == 2) {
                                              value.getCategory(search: value.categoryCtrl.text);
                                            }
                                          })
                                        : null,
                                    onChanged: (val) {
                                    ...
                                    onFieldSubmitted: (v) => value.getCategory(search: value.categoryCtrl.text),
                                  ).padding(bottom: Insets.i15, horizontal: Insets.i20),
                                  ...value.categoryList.asMap().entries.map((e) => ListTileLayout(
                                          data: e.value,
                                          selectedCategory: value.statusList,
                                          index: e.key,
                                          onTap: () => value.onCategoryChange(context, e.value.id))
                                      .inkWell(onTap: () => value.onCategoryChange(context, e.value.id)))
                                ]),
                              ),
                            )
                          : Expanded(
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                CommonArrow(arrow: eSvgAssets.arrowLeft, onTap: () => value.onLeftArrow()),
                                ...
                                Container(
                                    ...
                                    child: DropdownButton(
                                        ...
                                        iconEnabledColor: appColor(context).darkText,
                                        ...
                                        onChanged: (choseVal) => value.onDropDownChange(choseVal))).boxShapeExtension(
                                    color: appColor(context).fieldCardBg, radius: AppRadius.r4),
                                const HSpace(Sizes.s20),
                                Container(
                                        alignment: Alignment.center,
                                        height: Sizes.s34,
                                ...
                                const HSpace(Sizes.s20),
                                CommonArrow(arrow: eSvgAssets.arrowRight, onTap: () => value.onRightArrow()),
                              ...
                              TableCalendar(
                                      ...
                                      onCalendarCreated: (controller) => value.onCalendarCreate(controller),
                                      ...
                                      calendarStyle: CalendarStyle(
                                          rangeHighlightColor: appColor(context).primary.withOpacity(0.10),
                                          rangeEndDecoration:
                                          ...
                                          withinRangeTextStyle:
                                              appCss.dmDenseLight14.textColor(appColor(context).primary),
                                          rangeStartTextStyle:
