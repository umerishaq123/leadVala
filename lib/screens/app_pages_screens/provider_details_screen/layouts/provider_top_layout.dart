...
class ProviderTopLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ProviderDetailsProvider>(builder: (context, providerCtrl, child) {
      return Container(
        ...
        child: Column(
          ...
          children: [
            ProfilePicCommon(
              isProfile: false,
              imageUrl: providerCtrl.provider!.media != null && providerCtrl.provider!.media!.isNotEmpty
            ...
            IntrinsicHeight(
                child: Row(
                  ...
                  if (providerCtrl.provider!.reviewRatings != null)
                    Column(children: [
                      RatingLayout(
                          initialRating: providerCtrl.provider!.reviewRatings != null
                              ? double.parse(providerCtrl.provider!.reviewRatings.toString())
                              : 0.0,
            ...
            const ServicesStatusButton(),
            const VSpace(Sizes.s8),
            const DottedLines(),
            const VSpace(Sizes.s10),
            ServicesDeliveredLayout(services: providerCtrl.provider!.served ?? "0"),
