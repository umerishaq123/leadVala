...
class HeadingRowCommon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Expanded(child: Text("Similar leads",overflow: TextOverflow.clip,style:isTextSize?   appCss.dmDenseBold18.textColor(appColor(context).darkText) :  appCss.dmDenseBold16.textColor(appColor(context).darkText))),
