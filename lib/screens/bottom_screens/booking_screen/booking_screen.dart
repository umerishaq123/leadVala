                                    ...
                                    Expanded(
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          print(
                                              'check out tho this list,${value.bookingList[index].provider!.id}');

                                          // print(
                                          //     "Booking details ==== ${value.bookingList[index].provider!.id}");

                                          ProviderModel providerModel =
                                              ProviderModel.fromJson(value
                                                  .bookingList[index].provider!
                                                  .toJson());
...
// 01-03-2025
              // Expanded(
                                    ...
                                    //     itemBuilder: (context, index) {
                                    //       print(
                                    //           "📌 Booking details: ${value.bookingList[index].provider}");

                                    //       // ✅ Check if provider is not null before accessing it
                                    //       ProviderModel? providerModel;

                                    //       if (value.bookingList[index]
                                    //               .provider !=
                                    //           null) {
                                    //         providerModel =
                                    //             ProviderModel.fromJson(value
                                    ...
                                    //           } else {
                                    //             print(
                                    //                 "⚠️ Provider details are missing for this booking.");
                                    //             Fluttertoast.showToast(
                                    //                 msg:
