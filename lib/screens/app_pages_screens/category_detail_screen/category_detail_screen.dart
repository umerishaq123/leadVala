...
class CategoryDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CategoriesDetailsProvider>(builder: (context1, value, child) {
      return StatefulWrapper(
        onInit: () => Future.delayed(DurationClass.ms150).then((val) => value.onReady(context)),
        child: PopScope(
          canPop: true,
          onPopInvoked: (didPop) {
          ...
          child: LoadingComponent(
            child: value.widget1Opacity == 0.0
                ...
                : Scaffold(
                    appBar: AppBarCommon(
                        title: value.categoryModel != null ? value.categoryModel!.title : "",
                            ...
                            Column(
                              ...
                              children: [
                                Text(language(context, appFonts.subCategories),
                                        style: appCss.dmDenseBold16.textColor(appColor(context).lightText))
                                    .paddingOnly(
                                  top: Insets.i15,
                                      ...
                                      child: Row(
                                              children: value.categoryModel!.hasSubCategories!
                                                  ...
                                                  .map((e) => TopCategoriesLayout(
                                                          ...
                                                          onTap: () =>
                                                              value.onSubCategories(context, e.key, e.value.id))
                                  ...
                                  return Column(
                                    children: value.serviceList
                                        ...
                                        .map((e) => FeaturedServicesLayout(
                                                ...
                                                addTap: () =>
                                                    value.getProviderById(context, e.value.userId, e.key, e.value),
