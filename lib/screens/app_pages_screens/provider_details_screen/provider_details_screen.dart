      ...
      return Consumer<ProviderDetailsProvider>(
        ...
        return PopScope(
          ...
          child: StatefulWrapper(
            onInit: () => Future.delayed(DurationClass.ms50).then((s) {
              print('call this function');
              value.onReady(context, id: id);
            }),
                ...
                child: value.widget1Opacity == 0.0
                    ...
                    : AnimatedOpacity(
                        ...
                        child: Scaffold(
                            appBar: AppBar(
                              leadingWidth: 80,
                              title: Text(language(context, 'Lead Details'),
                              ...
                              return SingleChildScrollView(
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      const ServicesStatusTimeline(
                                          statusTimeline: [
                                            {
                                              "title": "Available",
                                              "date": "9:00 AM - 6:00 PM",
                                              "status": "active"
                                            },
                                            {
                                              "title": "Unavailable",
                                              "date": "6:00 PM - 9:00 AM",
                                              "status": "inactive"
                                            },
                                          ]),
                                      ...
                                      ...value.serviceList.asMap().entries.map(
