...
/// Convert `BookingResponseModel` to JSON string
...
class Service {
  ...
  List<Category>? categories; // ✅ Added Category support
  List<Media>? media;
  ...
  factory Service.fromJson(Map<String, dynamic> json) => Service(
        ...
        categories: json["categories"] == null
            ? []
            : List<Category>.from(
                json["categories"].map((x) => Category.fromJson(x))), // ✅ Fixed
  ...
  Map<String, dynamic> toJson() => {
        ...
        "categories": categories == null
            ? []
            : List<dynamic>.from(categories!.map((x) => x.toJson())), // ✅ Fixed
        "media": media == null
            ? []
...
class BookingResponseModel {
  ...
  factory BookingResponseModel.fromJson(Map<String, dynamic> json) =>
      BookingResponseModel(
        currentPage:
            (json["current_page"] as num?)?.toInt(), // ✅ Convert to int
        data: json["data"] == null
            ? []
            : List<Datum>.from(json["data"]!.map((x) => Datum.fromJson(x))),
        firstPageUrl: json["first_page_url"],
        from: (json["from"] as num?)?.toInt(), // ✅ Convert to int
        lastPage: (json["last_page"] as num?)?.toInt(), // ✅ Convert to int
        lastPageUrl: json["last_page_url"],
        links: json["links"] == null
            ? []
            : List<Link>.from(json["links"]!.map((x) => Link.fromJson(x))),
        nextPageUrl: json["next_page_url"],
        path: json["path"],
        perPage: (json["per_page"] as num?)?.toInt(), // ✅ Convert to int
        prevPageUrl: json["prev_page_url"],
        to: (json["to"] as num?)?.toInt(), // ✅ Convert to int
        total: (json["total"] as num?)?.toInt(), // ✅ Convert to int
      );
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        bookingNumber: (json["booking_number"] as num?)?.toInt(),
        ...
        perServicemanCharge: (json["per_serviceman_charge"] as num?)?.toInt(),
        couponTotalDiscount: (json["coupon_total_discount"] as num?)?.toInt(),
        platformFees: (json["platform_fees"] as num?)?.toInt(),
        requiredServicemen: (json["required_servicemen"] as num?)?.toInt(),
        totalExtraServicemen: (json["total_extra_servicemen"] as num?)?.toInt(),
        totalServicemen: (json["total_servicemen"] as num?)?.toInt(),
        totalExtraServicemenCharge:
            (json["total_extra_servicemen_charge"] as num?)?.toInt(),
        subtotal: (json["subtotal"] as num?)?.toInt(),
        total: (json["total"] as num?)?.toDouble(), // Keep as double
        tax: (json["tax"] as num?)?.toDouble(), // Keep as double
  ...
  //       bookingStatusLogs: json["booking_status_logs"] == null
  //           ? []
  //           : List<BookingStatusLog>.from(json["booking_status_logs"]!
  //               .map((x) => BookingStatusLog.fromJson(x))),
  //       consumer: json["consumer"] == null
  //           ? null
  //           : Consumer.fromJson(json["consumer"]),
  //       address:
  //           json["address"] == null ? null : Address.fromJson(json["address"]),
  //       bookingReasons: json["booking_reasons"] == null
  //           ? []
  //           : List<dynamic>.from(json["booking_reasons"]!.map((x) => x)),
  //       serviceProofs: json["service_proofs"] == null
  //           ? []
  //           : List<dynamic>.from(json["service_proofs"]!.map((x) => x)),
  //       extraCharges: json["extra_charges"] == null
  //           ? []
  //           : List<dynamic>.from(json["extra_charges"]!.map((x) => x)),
  //     );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "booking_status_logs": bookingStatusLogs == null
            ? []
            : List<dynamic>.from(bookingStatusLogs!.map((x) => x.toJson())),
        "consumer": consumer?.toJson(),
        "address": address?.toJson(),
        "booking_reasons": bookingReasons == null
            ? []
            : List<dynamic>.from(bookingReasons!.map((x) => x)),
        "service_proofs": serviceProofs == null
            ? []
            : List<dynamic>.from(serviceProofs!.map((x) => x)),
        "extra_charges": extraCharges == null
            ? []
            : List<dynamic>.from(extraCharges!.map((x) => x)),
      };
}
...
class Provider {
  ...
  factory Provider.fromJson(Map<String, dynamic> json) => Provider(
        ...
        zones: json["zones"] == null
            ? []
            : List<ProviderZone>.from(
                json["zones"]!.map((x) => ProviderZone.fromJson(x))),
        roles: json["roles"] == null
            ? []
            : List<Role>.from(json["roles"]!.map((x) => Role.fromJson(x))),
        reviews: json["reviews"] == null
...
class Category {
  ...
  factory Category.fromJson(Map<String, dynamic> json) => Category(
        ...
        zones: json["zones"] == null
            ? []
            : List<CategoryZone>.from(
                json["zones"]!.map((x) => CategoryZone.fromJson(x))),
      );
