...
class FeaturedServicesLayout extends StatelessWidget {
  ...
  const FeaturedServicesLayout(
      {super.key, this.data, this.onTap, this.isProvider = true, this.addTap, this.inCart = false});
            ...
            child: Column(children: [
                ...
                if (data!.discount != "")
                  Row(
                      ...
                      children: [
                        Container(),
                        SizedBox(
                                child: Text("${data!.discount!}% ${language(context, appFonts.off)}",
                                        style: appCss.dmDenseMedium12.textColor(appColor(context).whiteColor))
                                    .padding(horizontal: Insets.i9, top: Insets.i3, bottom: Insets.i3))
                            .decorated(color: appColor(context).red, borderRadius: BorderRadius.circular(AppRadius.r30))
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    children: [
                      Expanded(
                        ...
                        IntrinsicHeight(
                          ...
                          Text("${data!.duration} ${capitalizeFirstLetter(data!.durationUnit)}",
                              style: appCss.dmDenseSemiBold12.textColor(appColor(context).online)),
                          VerticalDivider(indent: 4, endIndent: 4, width: 1, color: appColor(context).lightText)
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                        Text(
                            ...
                            style: appCss.dmDenseRegular14.textColor(appColor(context).lightText).lineThrough),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Row(children: [
                    DottedLines(width: MediaQuery.of(context).size.width - 155),
                    SvgPicture.asset(eSvgAssets.arrowRight1,
                        colorFilter: ColorFilter.mode(appColor(context).stroke, BlendMode.srcIn))
                  ]),
                  const HSpace(Sizes.s10),
                  (inCart!) ? AddedButtonCommon(onTap: addTap) : AddButtonCommon(onTap: addTap)
                ]),
                if (data!.description != null)
                  Text(capitalizeFirstLetter(data!.description!),
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: appCss.dmDenseMedium13.textColor(appColor(context).lightText))
                      .marginOnly(
                          right: rtl(context) ? 0 : Insets.i70, left: rtl(context) ? Insets.i70 : 0, bottom: Sizes.s6)
