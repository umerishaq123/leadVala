...
class ServicePackageList extends StatelessWidget {
  ...
  const ServicePackageList({super.key, this.data, this.onTap, this.isViewAll = false, this.rotationAnimation});
        ...
        Stack(children: [
          Container(
              padding: EdgeInsets.only(
                  top: Insets.i15,
                  left: AppLocalizations.of(context)?.locale.languageCode == "ar" ? 0 : Insets.i15,
                  right: AppLocalizations.of(context)?.locale.languageCode == "ar" ? Insets.i15 : 0),
              decoration: ShapeDecoration(
                  shape: SmoothRectangleBorder(borderRadius: SmoothBorderRadius(cornerRadius: 10, cornerSmoothing: 1)),
                  color:
                      data!.hexaCode != null ? fromHex(data!.hexaCode!) : appColor(context).primary.withOpacity(0.8)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(data!.title!,
                                    ...
                                    style: isViewAll == true
                                        ? appCss.dmDenseMedium14.textColor(appColor(context).whiteBg)
                                        : appCss.dmDenseMedium12.textColor(appColor(context).whiteBg))
                          ...
                          Text(
                              ...
                              style: isViewAll == true
                                  ? appCss.dmDenseBold18.textColor(appColor(context).whiteBg)
                                  : appCss.dmDenseBold14.textColor(appColor(context).whiteBg)),
                        ],
                      ),
                    ),
