...
class UserModel {
  ...
  /// ✅ **Fix Integer to String Conversion Issue**
  UserModel.fromJson(Map<String, dynamic> json) {
    ...
    code = json['code']?.toString(); // ✅ Convert int to String
    ...
    /// ✅ **Ensure Media List is Parsed Correctly**
    if (json['media'] != null) {
      media = <Media>[];
    ...
    /// ✅ **Ensure Known Languages List is Parsed Correctly**
    ...
    /// ✅ **Ensure Expertise List is Parsed Correctly**
