    ...
    return Container(
        ...
        decoration: ShapeDecoration(
            shape: const SmoothRectangleBorder(
                borderRadius: SmoothBorderRadius.only(
                    topLeft: SmoothRadius(cornerRadius: AppRadius.r20, cornerSmoothing: 1),
                    topRight: SmoothRadius(cornerRadius: AppRadius.r20, cornerSmoothing: 0.4))),
        ...
        child: Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            SvgPicture.asset(eSvgAssets.close).inkWell(onTap: () => route.pop(context)),
          ]).paddingAll(Insets.i20),
          Container(
              width: MediaQuery.of(context).size.width,
              decoration:
                  BoxDecoration(image: DecorationImage(image: AssetImage(eImageAssets.detailsBg), fit: BoxFit.fill)),
              child: Column(children: [
                Column(children: [
                  BillRowCommon(
                ...
                Divider(color: appColor(context).stroke, thickness: 1, height: 1, endIndent: 6, indent: 6),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
