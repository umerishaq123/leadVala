...
class _DashboardState extends State<Dashboard> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Consumer4<DashboardProvider, ThemeService, CommonPermissionProvider, LocationProvider>(
      ...
      return PopScope(
        ...
        child: StatefulWrapper(
          ...
          child: Scaffold(
              floatingActionButton: MediaQuery.of(context).viewInsets.bottom != 0 && value.isTap == true
                  ? null
                  : FloatingActionButton(
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppRadius.r50)),
                      onPressed: () => value.cartTap(context),
                      child: Consumer<CartProvider>(builder: (context4, cart, child) {
                        return Stack(alignment: Alignment.center, children: [
                          SvgPicture.asset(cart.cartList.isEmpty ? eSvgAssets.cart : eSvgAssets.cartFill),
                            ...
                            Positioned(
                                ...
                                child: Container(
                                        child: Text(cart.cartList.length.toString(),
                                                style: appCss.dmDenseMedium8.textColor(appColor(context).whiteColor))
              ...
              bottomNavigationBar: Container(
                ...
                decoration: ShapeDecoration(
                    ...
                    shadows: [
                      BoxShadow(color: appColor(context).darkText.withOpacity(0.10), blurRadius: 4, spreadRadius: 0)
                    ]),
                child: ClipRRect(
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        isDark(context)
                                            ? AnimatedScale(
                                                ...
                                                scale: value.selectIndex == e.key && value.expanded ? 1.3 : 1,
                                                child: SvgPicture.asset(
                                                    value.selectIndex == e.key ? e.value["icon2"]! : e.value["icon"]!,
                                                    height: Sizes.s24,
                                                    width: Sizes.s24,
                                        ...
                                        Text(language(context, e.value["title"]!),
                                          ...
                                          .marginOnly(right: e.key == 1 ? 25 : 0, left: e.key == 2 ? 20 : 0)
